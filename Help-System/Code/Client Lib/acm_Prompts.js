...
if (typeof window.ACM_PROMPTS_LOADED === 'undefined') {
    window.ACM_PROMPTS_LOADED = true;

/**
 * Application Title Configuration
 * Change this constant to customize the title for all popup dialogs
 */
const ACM_APP_TITLE = 'Great Lakes Heritage - Collections.';
